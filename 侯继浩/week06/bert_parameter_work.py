...
# 可训练参数
# embeddings层 vocab_size*hidden_size*5
#
# 计算attention层 num_hidden_layers*((hidden_size*hidden_size+hidden_size)*4+hidden_size
# +hidden_size+intermediate_size*hidden_size+intermediate_size+hidden_size*intermediate_size
# +hidden_size+hidden_size+hidden_size)
#
# pooler层  hidden_size*hidden_size+hidden_size