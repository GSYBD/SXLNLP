...
class LanguageModel(nn.Module):
    def __init__(self, input_dim, vocab_size):
        ...
        self.bert = BertModel.from_pretrained(r"D:\Study\kejian\第六周 预训练模型\bert-base-chinese", return_dict=False)
...
def train(corpus_path, save_weight=True):
    ...
    tokenizer = BertTokenizer.from_pretrained(r"D:\Study\kejian\第六周 预训练模型\bert-base-chinese")
    vocab_size = 21128
