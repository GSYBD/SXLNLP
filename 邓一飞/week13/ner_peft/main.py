...
def main(config):
    ...
    if peft_type == 'lora':
        peft_config = LoraConfig(r=8,lora_alpha=32,lora_dropout=0.1,target_modules=['query','kes','value'])
    else:
        pass
