...
class TorchModel(nn.Module):
    def __init__(self, config):
        ...
        if model_type == "fast_text":
            ...
            self.use_bert = True
            self.encoder = BertModel.from_pretrained(config["pretrained_model_path"], return_dict=False)
...
class BertLSTM(nn.Module):
    def __init__(self, config):
        ...
        self.bert = BertModel.from_pretrained(config["pretrained_model_path"], return_dict=False)
...
if __name__ == "__main__":
    ...
    model = BertModel.from_pretrained(config["pretrained_model_path"], return_dict=False)
