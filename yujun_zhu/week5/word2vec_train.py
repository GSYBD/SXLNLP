...
def train_word2vec_model(corpus, dim):
    ...
    model.save(osp.join(current_dir, "model.w2v"))
    return model
...
def main():
    sentences = []
    with open(osp.join(current_dir, "corpus.txt"), encoding="utf8") as f:
        for line in f:
...
if __name__ == "__main__":
    ...
    model = load_word2vec_model(osp.join(current_dir, "model.w2v"))  #加载
