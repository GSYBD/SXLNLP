...
bert = BertModel.from_pretrained(r"/media/quintus/新加卷/zyj/八斗精品班/第六周 预训练模型/bert-base-chinese", return_dict=False)
...
# Calculating trainable parameters in DiyBert
diy_bert_params = 0
for key in db.__dict__.keys():
    param = db.__dict__[key]
    if isinstance(param, list):
        for sub_param in param:
            if isinstance(sub_param, np.ndarray):
                diy_bert_params += sub_param.size
                print("DiyBert - key name: ", key)
                print("DiyBert - sub param size: ", sub_param.size)
                print("DiyBert - sub param shape: ", sub_param.shape)
    elif isinstance(param, np.ndarray):
        diy_bert_params += param.size
        print("DiyBert - key name: ", key)
        print("DiyBert - param size: ", param.size)
        print("DiyBert - param shape: ", param.shape)

# Calculating trainable parameters in transformers BERT model
torch_bert_params = 0
for name, param in bert.named_parameters():
    torch_bert_params += param.numel()
    print("BERT - key name: ", name)
    print("BERT - param size: ", param.numel())
    print("BERT - param shape: ", param.shape)

print("diy bert params: ", diy_bert_params)
print("torch bert params: ", torch_bert_params)

# DiyBert - key name:  word_embeddings
# DiyBert - param size:  16226304
# DiyBert - param shape:  (21128, 768)
# DiyBert - key name:  position_embeddings
# DiyBert - param size:  393216
# DiyBert - param shape:  (512, 768)
# DiyBert - key name:  token_type_embeddings
# DiyBert - param size:  1536
# DiyBert - param shape:  (2, 768)
# DiyBert - key name:  embeddings_layer_norm_weight
# DiyBert - param size:  768
# DiyBert - param shape:  (768,)
# DiyBert - key name:  embeddings_layer_norm_bias
# DiyBert - param size:  768
# DiyBert - param shape:  (768,)
# DiyBert - key name:  pooler_dense_weight
# DiyBert - param size:  589824
# DiyBert - param shape:  (768, 768)
# DiyBert - key name:  pooler_dense_bias
# DiyBert - param size:  768
# DiyBert - param shape:  (768,)
# BERT - key name:  embeddings.word_embeddings.weight
# BERT - param size:  16226304
# BERT - param shape:  torch.Size([21128, 768])
# BERT - key name:  embeddings.position_embeddings.weight
# BERT - param size:  393216
# BERT - param shape:  torch.Size([512, 768])
# BERT - key name:  embeddings.token_type_embeddings.weight
# BERT - param size:  1536
# BERT - param shape:  torch.Size([2, 768])
# BERT - key name:  embeddings.LayerNorm.weight
# BERT - param size:  768
# BERT - param shape:  torch.Size([768])
# BERT - key name:  embeddings.LayerNorm.bias
# BERT - param size:  768
# BERT - param shape:  torch.Size([768])
# BERT - key name:  encoder.layer.0.attention.self.query.weight
# BERT - param size:  589824
# BERT - param shape:  torch.Size([768, 768])
# BERT - key name:  encoder.layer.0.attention.self.query.bias
# BERT - param size:  768
# BERT - param shape:  torch.Size([768])
# BERT - key name:  encoder.layer.0.attention.self.key.weight
# BERT - param size:  589824
# BERT - param shape:  torch.Size([768, 768])
# BERT - key name:  encoder.layer.0.attention.self.key.bias
# BERT - param size:  768
# BERT - param shape:  torch.Size([768])
# BERT - key name:  encoder.layer.0.attention.self.value.weight
# BERT - param size:  589824
# BERT - param shape:  torch.Size([768, 768])
# BERT - key name:  encoder.layer.0.attention.self.value.bias
# BERT - param size:  768
# BERT - param shape:  torch.Size([768])
# BERT - key name:  encoder.layer.0.attention.output.dense.weight
# BERT - param size:  589824
# BERT - param shape:  torch.Size([768, 768])
# BERT - key name:  encoder.layer.0.attention.output.dense.bias
# BERT - param size:  768
# BERT - param shape:  torch.Size([768])
# BERT - key name:  encoder.layer.0.attention.output.LayerNorm.weight
# BERT - param size:  768
# BERT - param shape:  torch.Size([768])
# BERT - key name:  encoder.layer.0.attention.output.LayerNorm.bias
# BERT - param size:  768
# BERT - param shape:  torch.Size([768])
# BERT - key name:  encoder.layer.0.intermediate.dense.weight
# BERT - param size:  2359296
# BERT - param shape:  torch.Size([3072, 768])
# BERT - key name:  encoder.layer.0.intermediate.dense.bias
# BERT - param size:  3072
# BERT - param shape:  torch.Size([3072])
# BERT - key name:  encoder.layer.0.output.dense.weight
# BERT - param size:  2359296
# BERT - param shape:  torch.Size([768, 3072])
# BERT - key name:  encoder.layer.0.output.dense.bias
# BERT - param size:  768
# BERT - param shape:  torch.Size([768])
# BERT - key name:  encoder.layer.0.output.LayerNorm.weight
# BERT - param size:  768
# BERT - param shape:  torch.Size([768])
# BERT - key name:  encoder.layer.0.output.LayerNorm.bias
# BERT - param size:  768
# BERT - param shape:  torch.Size([768])
# BERT - key name:  pooler.dense.weight
# BERT - param size:  589824
# BERT - param shape:  torch.Size([768, 768])
# BERT - key name:  pooler.dense.bias
# BERT - param size:  768
# BERT - param shape:  torch.Size([768])
# diy bert params:  17213184
# torch bert params:  24301056