...
class LanguageModel(nn.Module):
    def __init__(self, input_dim, vocab_size):
        ...
        self.bert = BertModel.from_pretrained(r"D:\Tools\JetBrains\Tool\bert-base-chinese", return_dict=False)
...
def train(corpus_path, save_weight=True):
    ...
    vocab_size = 21128
    tokenizer = BertTokenizer.from_pretrained(r"D:\Tools\JetBrains\Tool\bert-base-chinese")
