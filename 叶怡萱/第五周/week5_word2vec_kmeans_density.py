...
def main():
    model = load_word2vec_model(r"C:\Users\admin\Desktop\软件\新建文件夹\第五周 词向量\week5 词向量及文本向量\model.w2v") #加载词向量模型
    sentences = load_sentence(r"C:\Users\admin\Desktop\软件\新建文件夹\第五周 词向量\week5 词向量及文本向量\titles.txt")  #加载所有标题
