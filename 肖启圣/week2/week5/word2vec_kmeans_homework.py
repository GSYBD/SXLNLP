...
#聚类计算及排序
def sorted_cluster(sentences,vectors):
    ...
    return new_label,mean_distance,sentence_label_dict


def main():
    model = load_word2vec_model(r"C:\Users\15007\Desktop\Python Learn\Learning data\Week5 词向量\week5 词向量及文本向量\model.w2v") #加载词向量模型
    sentences = load_sentence("titles.txt")  #加载所有标题
    vectors = sentences_to_vectors(sentences, model)   #将所有标题向量化

    new_label,mean_distance,sentence_label_dict = sorted_cluster(sentences, vectors)
