...
class LanguageModel(nn.Module):
    def __init__(self, input_dim, vocab_size):
        ...
        self.bert = BertModel.from_pretrained(r"/Users/xulingping/Documents/nlp_codes/week7_nlp_xlp/nn_pipline/bert-base-chinese",return_dict=False)
...
def build_sample(tokenizer, window_size, corpus):
    ...
    #print("len(corpus) - 1 - window_size",len(corpus) - 1 - window_size)
...
def train(corpus_path, save_weight=True):
    ...
    tokenizer = BertTokenizer.from_pretrained(r"/Users/xulingping/Documents/nlp_codes/week7_nlp_xlp/nn_pipline/bert-base-chinese")
    vocab_size = 3
    print("type of number",type(vocab_size))
    print("type of number", type(768))
    print(type(vocab_size)==type(768))
...
if __name__ == "__main__":
    ...
    train("/Users/xulingping/Documents/nlp_codes/week10_nlp_xlp/corpus.txt", False)
