...
bert = BertModel.from_pretrained(r"D:\BaiduNetdiskDownload\八斗精品班\第六周 预训练模型\bert-base-chinese", return_dict=False)
...
# Transformer参数:
# Q k v 多头
attention_qkv = 3 * hidden_size * hidden_size / parameter.num_attention_heads
attention_output_layer = hidden_size * hidden_size
attention_parmenters = hidden_size * hidden_size
attetion_bias = parameter.num_attention_heads * parameter.max_position_embeddings * parameter.max_position_embeddings
...
#前馈网络参数:
feedforward_intermediate = hidden_size * parameter.intermediate_size
feedforward_output_layer = parameter.intermediate_size * hidden_size
