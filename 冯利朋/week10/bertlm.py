...
tokenizer = BertTokenizer.from_pretrained("/Users/lipengfeng/Documents/huggingface/bert-base-chinese")

class LanguageModel(nn.Module):
    def __init__(self):
        super(LanguageModel, self).__init__()
        self.bert = BertModel.from_pretrained("/Users/lipengfeng/Documents/huggingface/bert-base-chinese", return_dict=False)
...
def generate_sentence(openings, model, window_size):
    ...
    with torch.no_grad():
        ...
        while pred_char != "\n" and len(openings) <= 30:
            openings += pred_char
            x = tokenizer.encode(openings, max_length=window_size, padding='max_length', truncation=True, add_special_tokens=False)
