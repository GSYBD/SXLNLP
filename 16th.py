...
class DialogSystem:
    ...
    def load(self):
        ...
        self.load_scenario("D:\BaiduNetdiskDownload\badou\第十六周 对话系统\week16 对话系统\scenario/scenario-买衣服.json")
        # self.load_scenario("scenario/scenario-看电影.json")

        # 加载槽位模板
        self.slot_info = {}
        self.slot_template("D:\BaiduNetdiskDownload\badou\第十六周 对话系统\week16 对话系统\scenario/slot_fitting_templet.xlsx")
