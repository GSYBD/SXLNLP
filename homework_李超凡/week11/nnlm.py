...
class LanguageModel(nn.Module):
    def __init__(self, vocab):
        ...
        self.bert_layer=BertModel.from_pretrained("/data/finetune_demo2/test/bert_gen/bert_base_chinese", return_dict=False)
...
def train(corpus_path, save_weight=True):
    ...
    vocab = build_vocab("../bert_gen/bert_base_chinese/vocab.txt")       #建立字表
