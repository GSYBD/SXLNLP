...
class LanguageModel(nn.Module):
    def __init__(self, input_dim, vocab_size):
        ...
        self.bert = BertModel.from_pretrained(r"D:\BaiduNetdiskDownload\八斗精品班\第六周 预训练模型\bert-base-chinese",return_dict=False)
...
def train(corpus_path, save_weight=True):
    ...
    tokenizer = BertTokenizer.from_pretrained(r"D:\BaiduNetdiskDownload\八斗精品班\第六周 预训练模型\bert-base-chinese")
    vocab_size = 3
...
if __name__ == "__main__":
    ...
    train("D:\BaiduNetdiskDownload\八斗精品班\第十周 生成式任务\week10 文本生成问题\lstm语言模型生成文本\corpus.txt", False)