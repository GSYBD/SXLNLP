...
class LanguageModel(nn.Module):
    ...
    def forward(self, x, mask=None, y=None):
        if y is not None:
            ...
            print(y_pred.shape)
            print(y_pred.view(-1, y_pred.shape[-1]))
            print(y.view(-1))
...
def main(corpus_path, save_weight=True):
    ...
    pretrain_model_path = r'/Users/serendipity/sdk/python/document/pre-model/bert-base-chinese'
...
if __name__ == "__main__":
    main("week11/sample_data.json", False)